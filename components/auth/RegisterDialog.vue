<template>
  <div>
    <el-button v-config:open_sign class="register-btn" @click="dialogVisible = true">注册</el-button>

    <el-dialog :append-to-body="true" v-model="dialogVisible" width="768px" :show-close="false"
      ...
      <div class="login-dialog-form-box">
        ...
        <div :class="['container', { 'right-panel-active': isSignUp }]">
          <div class="form-container sign-up-container">
            ...
            <el-form ref="registerRuleFormRef" class="forms_form" :model="registerForm" size="small"
              :rules="registerRules">
              <!-- 昵称 -->
            ...
            <el-button class="ghost-button forms_buttons-action" :loading="isRegisterLoading"
