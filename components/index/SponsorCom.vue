<template>
  <div ref="sponsorRef" v-config:open_sponsor class="sponsor-box-wraper">
    <introduce-title-vue title="成为赞助者" subtitle="一杯奶茶钱，即可将您的Logo展示在下方，给您带来源源不断的流量。" title-color="#000"
    ...
    <el-dialog :model-value="dialogVisible" class="sponsor-dialog-wrapper" title="请填写赞助信息" width="840px"
      :show-close="false" :close-on-click-modal="false">
        <ElScrollbar trigger="hover" style="height: 500px">
            ...
            <div class="right">
              ...
              <el-form ref="ruleFormRef" :model="ruleForm" :rules="rules" size="default" label-width="120px"
                ...
                <el-form-item label="电子邮箱:">
                  <el-input v-model="ruleForm.email" type="email" placeholder="个人或者企业的电子邮箱" />
                </el-form-item>
                ...
                <el-form-item label="上传logo:">
                  <el-upload class="avatar-uploader" :action="uploadAddress()"
                ...
                <el-form-item label="上传支付凭证:">
                  <el-upload class="avatar-uploader" :action="uploadAddress()"
                    :headers="{ Authorization: token }" :show-file-list="false"
                    :on-success="handlePaySuccess" :before-upload="beforePayUpload">
      ...
      <template #footer>
        <span class="dialog-footer">
          ...
          <el-button type="primary" :loading="isAddLoading" @click="confirm(ruleFormRef)">确定</el-button>
        </span>
      </template>
    </el-dialog>
  </div>
...
import { getSponsorListAsync } from '~/composables/api/sponsor';
...
// 上传文件地址
const uploadAddress = () => {
  return config.public.apiBase + '/huajian/upload/file/logo';
};
