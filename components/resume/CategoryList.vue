<template>
  <div class="category-list-box">
    ...
    <div class="list-item-box">
      <span :class="['all-label li', { active: !filterValue.templateStyle }]"
        @click="filterValue.templateStyle = ''">风格</span>
      <ul>
        <li v-for="(item, index) in categoryList" :key="index"
          :class="['li', { active: filterValue.templateStyle === item }]" @click="handleSelectStyle(item)">
          {{ item }}
        </li>
      </ul>
    </div>
    <!-- 简历用途 -->
    <div class="list-item-box">
      <span :class="['all-label li', { active: !filterValue.templateUse }]"
        @click="filterValue.templateUse = ''">用途</span>
      <ul>
        <li v-for="(item, index) in templateUseList" :key="index"
          :class="['li', { active: filterValue.templateUse === item.label }]" @click="handleSelectUse(item)">
          {{ item.label }}
        </li>
      </ul>
    </div>
    ...
    <!-- 简历行业 -->
    <div class="list-item-box">
      <span :class="['all-label li', { active: !filterValue.templateIndustry }]"
        @click="templateIndustryClick">行业</span>
      <ul>
        <li v-for="(item, index) in templateIndustryList" :key="index"
          :class="['li', { active: filterValue.templateIndustry === item.label }]" @click="handleSelectIndustry(item)">
          {{ item.label }}
        </li>
      </ul>
    </div>
    ...
    <!-- 具体职业 -->
    <div class="list-item-box">
      <span :class="['all-label li', { active: !filterValue.templatePost }]"
        @click="filterValue.templatePost = ''">职业</span>
      <ul>
        <li v-for="(item, index) in templatePostListCP" :key="index"
          :class="['li', { active: filterValue.templatePost === item }]" @click="handleSelectTemplatePost(item)">
          {{ item }}
        </li>
      </ul>
    </div>
...
// 查询模版风格
const categoryList = ref<any>(['时尚', '创意', '简洁', '经典']);
...
const handleSelectStyle = (item: any) => {
  filterValue.templateStyle = item;
};
