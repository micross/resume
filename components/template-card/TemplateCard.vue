<template>
  <div class="card-wraper" @mouseover="mouseover" @mouseleave="mouseleave">
    <div class="template-card-box">
      <img :src="cardData.template_cover" :alt="cardData.template_title" :title="cardData.template_title" />
      <!-- 遮罩层 -->
      <div ref="maskLayerRef" class="mask-layer">
        <Dialog v-model:open="dialogVisible" @close="close">
        ...
        <Button class="design-button" variant="default" @click="toDesign">
          立即免费制作
        </Button>
      </div>
    </div>
    ...
    <div class="viewer-box">
      ...
      <div class="icon-box">
        <svg-icon v-config:open_comment icon-name="icon-pinglun1" color="#a3abb1" size="19px"></svg-icon>
