<template>
  <ElDrawer
    ...
    @close="handleClose"
  >
    <ModuleSelect v-if="drawer" :show-module-name="false" :show-title="false"></ModuleSelect>
  </ElDrawer>
</template>
<script lang="ts" setup>
  import ModuleSelect from '~/pages/createTemplate/designer/components/ModuleSelect.vue';
