<template>
  <el-popover popper-class="component-type-select-pop-box" :teleported="teleported" :width="150" trigger="click">
    <template #reference>
    ...
    <div class="component-type-select">
      <div v-for="(item, index) in cptSwitchList(type)" :key="index" class="icon-list-item"
