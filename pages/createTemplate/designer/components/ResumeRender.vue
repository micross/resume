<template>
  <div ref="pageWrapperRef" v-loading="isLoading" class="page-wrapper">
    <div ref="componentBoxRef" class="components-wrapper">
      <!-- 动态渲染的组件，添加ref -->
      <component :is="pageComponents[HJNewJsonStore.props.pageName]" ref="dynamicComponentRef"></component>
      <!-- 分页线 -->
      <template v-if="lineNumber > 0">
        <div v-for="index in lineNumber" :key="index" class="lines" :style="{ top: `${1160 * index}px` }">
