<template>
  <div class="reset-password-box">
    <div v-if="!showCountdown" class="form-box">
      <el-alert v-if="isShowError" title="设置密码失败,请尝试重新发送重置邮件" :closable="false" type="error" effect="dark"
        style="margin-bottom: 40px" />
      <el-form ref="resetRuleFormRef" label-width="80px" label-position="left" :model="formLabelAlign"
        :rules="registerRules">
        ...
        <el-form-item>
          <el-button type="primary" class="forms_buttons-action" :loading="isLoading"
            @click="reset(resetRuleFormRef)">确认重置</el-button>
        </el-form-item>
      </el-form>
    </div>
...
import { resetPasswordAsync } from '~/composables/api/user';
